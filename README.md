...
| CursorBench | [Cursor](https://cursor.com/cursorbench) | hand-curated from the published leaderboard page (benchmark itself is closed-source) |

Hand-curated tables are clearly marked in the UI and carry their source link. They're the fallback for benches whose owners publish numbers but not data files.
